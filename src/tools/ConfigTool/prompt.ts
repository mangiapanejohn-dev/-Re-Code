...
export const DESCRIPTION = 'Get or set RE CODE configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set RE CODE configuration settings.

  View or change RE CODE settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
