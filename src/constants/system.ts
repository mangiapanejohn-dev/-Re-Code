...
const DEFAULT_PREFIX = `You are RE CODE, an AI coding assistant built by MarkEllington.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are RE CODE, an AI coding assistant built by MarkEllington, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are RE CODE, an AI agent built by MarkEllington on top of the Claude Agent SDK.`
