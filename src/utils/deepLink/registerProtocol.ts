...
const APP_NAME = 'RE CODE URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'RE CODE URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>RE CODE Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for RE CODE
