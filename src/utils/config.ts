...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when RE CODE was first started on this machine
  ...
  // RE CODE usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first RE CODE OAuth token
  ...
  // RE CODE hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
