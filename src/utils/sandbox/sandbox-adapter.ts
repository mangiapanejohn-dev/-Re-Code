...
/**
 * Resolve RE CODE-specific path patterns for sandbox-runtime.
 *
 * RE CODE uses special path prefixes in permission rules:
...
/**
 * Convert RE CODE settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where RE CODE started)
