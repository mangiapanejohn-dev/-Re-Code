    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport requires a linked subscription account.</Text><Text dimColor={true}>Your Pro/Max subscription will be used by RE CODE.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
        ...
        if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
          t10 = <Dialog title="Log in to RE CODE" onCancel={onCancel}>{t9}<Select options={[{
              label: "Log in with subscription account",
              value: "login"
            }, {
              label: "Exit",
              value: "exit"
